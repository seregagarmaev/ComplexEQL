...
class ModelTrainingConfig:
    ...
    # -------------------------
    imag_weights_penalty_enabled_phase1 = False#True
    imag_weights_penalty_enabled_phase2 = False#True
    imag_weights_penalty_enabled_phase3 = False#True
    ...
    # -------------------------
    imag_shrink_enabled_phase1 = False#True
    imag_shrink_enabled_phase2 = False#True
    imag_shrink_enabled_phase3 = False#True
